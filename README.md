...
- [service-mesh-observability-boundary.md](../../lhdht/backend/design/mesh/v2/service-mesh-observability-boundary.md)
- [service-mesh-identity-boundary.md](../../lhdht/backend/design/mesh/v2/service-mesh-identity-boundary.md)
- [service-mesh-delivery-boundary.md](../../lhdht/backend/design/mesh/v2/service-mesh-delivery-boundary.md)
- [service-mesh-source-provider-matrix.md](../../lhdht/backend/design/mesh/v2/service-mesh-source-provider-matrix.md)
- [service-mesh-state-model.md](../../lhdht/backend/design/mesh/v2/service-mesh-state-model.md)
- [service-mesh-migration-playbook.md](../../lhdht/backend/design/mesh/v2/service-mesh-migration-playbook.md)
- [service-mesh-runtime-assembly.md](../../lhdht/backend/design/mesh/v2/service-mesh-runtime-assembly.md)
- [service-mesh-code-refactor-checklist.md](../../lhdht/backend/design/mesh/v2/service-mesh-code-refactor-checklist.md)
